    ...
    return (
        ...
        <div className="relative grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {restorans.map((restoran) => [
                ...
                <div key={restoran.id} className="p-5 flex flex-col items-cente justify-between text-center gap-2">
                    ...
                    <p className="mb-2 font-bold font-name-rest text-sm">{restoran.name}</p>
